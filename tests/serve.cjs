...
http.createServer((req,res)=>{
 ...
 for(const file of ['command-model.js','command-ui.js','film-workspace.js','command.css','stats-import.js','stats-import-ui.js','vendor/xlsx.full.min.js'])files['/'+file]=file;
