...
2. **BETA:** After an explicit approval, promote only the reviewed queued revision. Apply only `20260915040422`, `20260915040423`, and `20260915040424` once, run `BETA-SMOKE-TEST.md`, and record results. Obtain a separate explicit approval before LIVE.
