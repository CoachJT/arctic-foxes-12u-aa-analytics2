...
- Verify Platform Admin has no film access unless separately an active team member.
- On 390px and 430px widths, confirm Team and Season selectors do not cover content or overflow.
- Verify bulk roster validation, score feedback, stat Enter navigation, Game Center states, and Action Center capability filtering.
- Record an explicit approval before any later LIVE promotion.
