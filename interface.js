/* 3.0.16 presentation only: reuse the existing save, navigation, rating and film functions. */
'use strict';
...
updates.innerHTML=workspaceHeader('Updates','Keep your coaching platform current. Your saved season stays with you.')+'<div id="updatesMount313"></div><div class="card"><h2>About this app</h2><p>Arctic Foxes Hockey Analytics <strong id="installed313">3.0.16</strong></p><p class="sub">Updates install through the existing GitHub release channel. Your games, roster, and season data are stored separately from the application.</p><button id="aboutStorage313">Open Save Folder</button></div>';
